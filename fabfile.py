...
def squash(app='', migration=''):
    local("docker exec -i $(docker ps | grep server_ | awk '{{ print $1 }}') python manage.py squashmigrations {} {}".format(app, migration))
